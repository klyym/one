...
import SyncTestButton from '@/components/sync-test-button';

const navigation = [
  { name: '数据看板', href: '/', icon: LayoutDashboard },
  { name: '设计跟进', href: '/projects', icon: FolderKanban },
  { name: '工程管理', href: '/construction', icon: HardHat },
  { name: '项目造价', href: '/cost', icon: Wallet },
