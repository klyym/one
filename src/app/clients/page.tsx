...
import { Plus, Search, Phone, Mail, MapPin, Building, MessageCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">客户联系人与合作统计</p>
        </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t text-sm">
                  <div className="flex gap-4">
                    <div>
                      ...
                      <span className="ml-1 font-medium">{clientProjects.length}</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">跟进</span>
                      <Badge variant="secondary" className="ml-1">{clientFollowUps.length}</Badge>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-muted-foreground">消费</span>
                    <span className="ml-1 font-medium text-green-600">
                      ¥{(client.totalSpent / 10000).toFixed(1)}万
                    </span>
                  </div>
                </div>
