...
export default function ProjectsPage() {
  ...
  const filteredProjects = projects.filter(project => {
    if ((project.stage ?? 'design') !== 'design') return false;
  ...
  const handleSaveProject = (formData: FormData) => {
    const projectData = {
      ...
      stage: (formData.get('stage') as ProjectStage) || 'design',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">设计跟进</h1>
          <p className="text-muted-foreground mt-1">设计阶段项目的跟进管理，点击客户名可查看客户信息</p>
        </div>
                ...
                {activeTab === 'basic' ? (
                  <>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <Select name="stage" defaultValue={editingProject?.stage || 'design'}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="progress">总体进度（%）</Label>
                        <Input
                          id="progress"
                          type="number"
                          min={0}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-t pt-4 space-y-3">
                      <p className="text-sm font-medium">添加跟进记录</p>
                      <div className="flex gap-3">
                        ...
                        />
                        <Input
                          placeholder="如：方案讨论，修改了玄关柜尺寸、厨房动线..."
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-2 text-sm text-muted-foreground mb-4">
                      ...
                      {project.contractAmount ? (
                        ...
                        <div>✏️ {designer?.name || '未分配设计师'}</div>
                      )}
                    ...
                    {isExpanded && (
                      <div className="mt-3 pt-4 border-t space-y-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-2 text-sm text-muted-foreground">
                          ...
                          <div>🧾 实际成本：{formatMoney(project.actualCost)}</div>
                          {project.description && (
                        ...
                        {sortedUpdates.length > 0 && (
                          <div>
                            <p className="text-sm font-medium mb-2">跟进记录</p>
                  ...
                  <div className="flex gap-2 shrink-0">
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        if (window.confirm(`确认将「${project.name}」转入施工管理？`)) {
                          updateProject(project.id, { stage: 'construction' });
                        }
                      }}
                    >
